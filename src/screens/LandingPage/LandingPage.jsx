...
export const LandingPage = () => {
  ...
  return (
    <>
      ...
      {/* Kontainer Utama */}
      <div id="main-scroll-container" className="fixed inset-0 z-[9999] h-screen w-screen overflow-y-auto overflow-x-hidden hide-scrollbar snap-y snap-mandatory bg-[#0b3848] text-white scroll-smooth">
                      ...
                      <>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
                          ...
                          <button 
                            ...
                            className="px-6 py-3 sm:px-8 sm:py-4 bg-white/10 text-white rounded-full font-bold hover:bg-white/20 transition-colors w-full sm:w-auto"
                          >
                            Baca dari Awal
                          </button>
                        </div>
